...
import { MapboxGLMap } from '@mapbox/react-native-mapbox-gl';
		...
		return (
			<View style={styles.container}>
				<MapboxGLMap
					...
					accessToken={
						'pk.eyJ1Ijoia2ltaW1vIiwiYSI6ImNqczBwb20wODFndm80M29heXZ3NGx0djYifQ.4-XY3xQflQ4aoinEohBqxQ'
					}
...
AppRegistry.registerComponent('TricycleProject', () => map);
